...
# Load the CSV file
df = pd.read_csv('100SOC_asym_15to40.csv')
...
def calculate_and_print_averages(df, start_time, end_time, T_left, T_right):
    ...
    print("T: ["+str(interval_df['T1 Last (C)'].mean()+0.2)+", "+str(interval_df['T2 Last (C)'].mean())+", "+str(interval_df['T3 Last (C)'].mean())+", "+str(interval_df['T4 Last (C)'].mean()+0.2)+", "+str(interval_df['T5 Last (C)'].mean())+"]")
...
# print("15 degrees")
# calculate_and_print_averages(df, 0, 200, 15, 15)
print("15 and 20 degrees")
calculate_and_print_averages(df, 19000, 20000, 15, 20)
print()
# print("20 degrees")
# calculate_and_print_averages(df, 45000, 46000, 20, 20)
print("20 and 25 degrees")
calculate_and_print_averages(df, 50000, 51000, 20, 25)
print()
# print("25 degrees")
# calculate_and_print_averages(df, 123000, 124000, 25, 25)
print("25 and 30 degrees")
calculate_and_print_averages(df, 98000, 99000, 25, 30)
print()
# print("30 degrees")
# calculate_and_print_averages(df, 161000, 162000, 30, 30)
print("30 and 35 degrees")
calculate_and_print_averages(df, 131000, 132000, 30, 35)
print()
# print("35 degrees")
# calculate_and_print_averages(df, 228000, 229000, 35, 35)
print("35 to 40 degrees")
calculate_and_print_averages(df, 168000, 169000, 35, 40)

# print("40 degrees")
# calculate_and_print_averages(df, 288000, 289000, 40, 40)

# print("15 degrees")
# calculate_and_print_averages(df, 36000, 37000, 15, 15)

# print("20 degrees")
# calculate_and_print_averages(df, 74000, 75000, 20, 20)

# print("25 degrees")
# calculate_and_print_averages(df, 101000, 102000, 25, 25)

# print("30 degrees")
# calculate_and_print_averages(df, 130000, 131000, 30, 30)

# print("35 degrees")
# calculate_and_print_averages(df, 156000, 157000, 35, 35)

# print("40 degrees")
# calculate_and_print_averages(df, 186000, 187000, 40, 40)