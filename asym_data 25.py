...
# Load the CSV file
df = pd.read_csv('25SOC_asym_15to40.csv')
...
print("15 degrees")
calculate_and_print_averages(df, 60000, 62000, 15, 15)
print("15 and 20 degrees")
calculate_and_print_averages(df, 128000, 130000, 15, 20)
print()
print("20 degrees")
calculate_and_print_averages(df, 154000, 156000, 20, 20)
print("20 and 25 degrees")
calculate_and_print_averages(df, 181000, 183000, 20, 25)
print()
print("25 degrees")
calculate_and_print_averages(df, 210000, 212000, 25, 25)
print("25 and 30 degrees")
calculate_and_print_averages(df, 242000, 244000, 25, 30)
print()
print("30 degrees")
calculate_and_print_averages(df, 272000, 274000, 30, 30)
print("30 and 35 degrees")
calculate_and_print_averages(df, 298000, 300000, 30, 35)
print()
print("35 degrees")
calculate_and_print_averages(df, 334000, 336000, 35, 35)
print("35 to 40 degrees")
calculate_and_print_averages(df, 362000, 364000, 35, 40)
print("40 degrees")
calculate_and_print_averages(df, 390000, 392000, 40, 40)
